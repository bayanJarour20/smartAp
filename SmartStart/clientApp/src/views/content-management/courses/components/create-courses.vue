                ...
                <template slot="activator">
                    ...
                    >
                        ...
                        <template slot="default">
                             <input type="file" id="upload-file" ref="excelFile"
                             accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"
                               hidden  @change="importExcelSubmit">
                            <label for="upload-file" refs="upload-file"
                                class="button text-nowrap mr-2 btn btn-secondary btn-sm"
                                v-if="!id" 
                            >
                                استيراد Exel
                                <unicon
...
export default {
    ...
    methods: {
        ...
        importExcelSubmit()
        {
            this.importExcel( this.$refs.excelFile.files[0]);
        }
    }
};
</script>
